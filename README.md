...
### vue前端，nodejs 后台api，数据库 mysql 构建的个人博客后台/
...
> 原作者 github地址 https://github.com/193Eric/vue-node-demo  感谢其分享学习 

> 采用element-ui的ui组件框架，结合webpack 打包的vue单页面后台系统。API接口是用Nodejs express框架。  
